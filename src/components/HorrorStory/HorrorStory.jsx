      ...
      <section className="AI">
        <div className="AI__wrapper">
          <div className="AI__left">
            {loading && <p className="AI__left-msg">Loading...</p>}
            {response && <p className="AI__left-msg">{response}</p>}
          </div>
          <div className="AI__right"></div>
          <div className="AI__left"></div>
        </div>
        <div className="AI__form">
          <textarea
            className="AI__input"
            name="message"
